            ...
            <div className="flex flex-col xl:flex-row">
                ...
                className="xl:max-w-[470px]">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                        Soluta optio nulla, quia magnam atque corporis, aperiam cupiditate
                         asperiores dolores cumque vitae nam libero? Porro praesentium 
                    </p>
                    {/* stats */}
                    ...
                    <p className="mb-10">Lorem ipsum dolor sit, amet consectetur adipisicing elit. 
                        Ratione sunt minus quas? Voluptatibus a unde nisi explicabo repellat nemo qui?
                    </p>
